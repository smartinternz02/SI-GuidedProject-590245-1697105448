...
app = Flask(__name__)
model = pickle.load(open(r"C:\Users\sreeja\Desktop\Ecommerce shipping prediction\Ecommerce shipping prediction\Flask\rf_acc_68.pkl", "rb"))
Data_normalizer = pickle.load(open(r"C:\Users\sreeja\Desktop\Ecommerce shipping prediction\Ecommerce shipping prediction\Flask\normalizer.pkl", "rb"))
@app.route('/')
def indput():
